...
| User interface | M4-D provides the read-only journey shell, five deterministic stop-state fixtures, checksum-verified downloads, interactive GLB preview, worker-isolated real G-code layer playback, generated API types, and a selectable persisted-evidence explorer |
