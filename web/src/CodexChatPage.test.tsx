...
describe('CodexChatPage', () => {
  ...
  it('streams a local Codex reply through the authenticated browser session', async () => {
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockImplementation(async (input) => {
      ...
      else if (url.endsWith('/api/v1/codex/turns')) body = { schema_version: '1.21.0', turn_id: 'turn_demo', accepted: true, tools_registered: 5 }
