...
describe('BuildSessionPage', () => {
  ...
  it('records one explicit approval without forcing a second confirmation screen', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Inspect the hardware layout and printable parts.' })).toBeInTheDocument()
  ...
  it('continues the robot Design plan into inspectable prototype CAD', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'Inspect the hardware layout and printable parts.' })).toBeInTheDocument()
