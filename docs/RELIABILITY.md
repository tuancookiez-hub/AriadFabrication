...
The read-only M4-A through M4-M application slices preserve evidence rather than creating it. M4-N adds a tested execution-control contract, and M4-O adds its internal transactional store without making the API writable:
